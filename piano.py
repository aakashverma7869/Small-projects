...
def note_C0():
	num1.set("C_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\A.wav")
	sound.play()


def note_CC0():
	num1.set("C#_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\B.wav")
	sound.play()

def note_D0():
	num1.set("D_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\Bb.wav")
	sound.play()

def note_DD0():
	num1.set("D#_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\C.wav")
	sound.play()

def note_E0():
	num1.set("E_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\C_s.wav")
	sound.play()

def note_F0():
	num1.set("F_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\C_s1.wav")
	sound.play()

def note_FF0():
	num1.set("F#_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\C1")
	sound.play()

def note_G0():
	num1.set("G_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\D.wav")
	sound.play()

def note_GG0():
	num1.set("G#_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\D_s.wav")
	sound.play()

def note_A0():
	num1.set("A_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\D_s1.wav")
	sound.play()

def note_AA0():
	num1.set("A#_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\D1.wav")
	sound.play()

def note_B0():
	num1.set("B_0")
	sound = pygame.mixer.Sound("C:\Music_Notes\E.wav")
	sound.play()
